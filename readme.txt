...
== Changelog ==
= 1.4.32 =
* Fixed blank tag generator in Contact Form 7

= 1.4.31 =
* Changed array syntax to pre-5.4 "array()" in ayah_wpm.php
...
= 1.3.8 =
* Updated ayah.php to version 1.1.5 (which was changed so that errors no longer occur when sites load multiple PlayThrus on the same page)

= 1.3.7 =
* Changed how stylesheet is registered to prevent warning message when debug is on.
...
= 1.3.1 =
* Updated ayah.php
* Gravity Forms and Contact Form 7 multiple PlayThru bug fixed

= 1.3.0 =
* Gravity Forms integration
* All form integrations are enabled by default
